let images = [{
  url: "./images/admiral.png",
  title: "Rostov-on-Don, Admiral"
}, {
  url: "./images/thieves.png",
  title: "Sochi Thieves"
}, {
  url: "./images/patriotic.png",
...
function initSlider(options) {
  ...
  function initNavigation() {
    images.forEach((image, index) => {
      let nav = `<li class="slider__navigation-item n${index} ${index === 0? "active" : ""}" data-index="${index}">${images[index].title}</li>`;
      sliderNavigation.innerHTML += nav;
    });
    sliderNavigation.querySelectorAll(".slider__navigation-item").forEach(nav => {
